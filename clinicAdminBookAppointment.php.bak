				...
				<form method="POST">
					<div class="row justify-content-center ps-5">
					  ...
					  <div class="row justify-content-center py-2">
						...
						<div class="col-lg-4">
						  <input type="text" class="form-control" id="usernameTB" disabled>
						</div>
					  </div>
					  <div class="row justify-content-center py-2">
						<label for="nricTB" class="col-lg-1 col-form-label">NRIC:</label>
						<div class="col-lg-4">
						  <input type="text" class="form-control" id="nricTB">
						</div>
					  </div>
					  <div class="row justify-content-center py-2">
					  ...
					  <div class="row justify-content-center py-2">
						<label for="datePicker" class="col-lg-1 col-form-label">Calendar:</label>
						<div class="col-lg-4">
