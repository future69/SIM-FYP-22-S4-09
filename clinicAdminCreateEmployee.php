...
<header>
	...
	$usernameError = $passwordError = $nricError = $fullNameError = $phoneNumError = $emailError = $addressError = $postalCodeError = $dobError = $pracNumberError = $qualificationError = null;
	$errorMessage = null;
