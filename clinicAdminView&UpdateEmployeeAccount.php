			...
			<div class="row justify-content-center align-items-center">
				<form method="POST">
					<div class="row justify-content-center ps-5">
					  ...
					  <div class="row justify-content-center align-items-center py-2">
						<label for="statusSL" class="col-lg-1 col-form-label">Status:</label>
						<div class="col-lg-4">
							<select class="form-select" class="form-select" aria-label="Select status" name="statusSL">
								<option value="plceaholder">Active</option>
								<option value="plceaholder">Suspended</option>
							</select>
						</div>
					  </div>
