...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
     ...
     <div class="container-lg">
        <div class="row justify-content-center align-items-center pt-3 p-2 display-6 fw-bold">Clinic Services</div>
        <div class="">
            <div class="row">
                <div class="col-md-3">
                    <!--Contatiner control-->
            ...
            <div class="col-md-6 border border-3 p-3 justify-content-center d-flex">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="justify-content-center d-flex mt-4 p-2">Result(s)</div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
										<td><a href="superadminUpdateService.php">Braces</a></td>
										<td>Open</td>
										<td>
                                    ...
                                    <tr>
										<td><a href="superadminUpdateService.php">Polishing</a></td>
										<td>Suspended</td>
										<td>
											<div class="form-check me-5" >
												<input class="form-check-input" type="radio" name="flexRadioDefault1" id="flexRadioDefault1">
                    ...
                    <div class="mt-4 text-center p-3">
                        <a href="superadminCreateService.php" class="btn btn-secondary">Create Service</a>
                    </div>
                </div>
            </div>
            </div>
