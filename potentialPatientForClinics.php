	...
	<body>
		<div class="container-lg">
			<div class="row ppHomepageArtBox justify-content-center align-items-center">
				<div class="row pb-5">
					<div class="row col-12 justify-content-center align-items-center display-3 text-center">Join Diamond Dental™ </div>
				</div>
				<div class="col-9 text-center text-md-start pb-5">
					<p class="fs-2 text-center lead"> Connect with thousands of users already using diamond dental in singapore and watch your business grow exponentially!
					</p>
				</div>
				<div class="col-10 text-center pb-5">
					<img class="img-fluid" src="images/dentistWoo.jpg">
				</div>
				<div class="row col-6 text-center justify-content-center align-items-center pb-5">
					<img class="col-6 w-25 img-fluid" src="images/loudspeaker.png">
					<p class="col-6 text-center fst-italic fs-3">Brand Awareness</p>
				</div>
				<div class="row col-6 text-center justify-content-center align-items-center pb-5">
					<img class="col-6 w-25 img-fluid" src="images/peopleLoading.png">
					<p class="col-6 text-center fst-italic fs-3">Increase in patient and booking turnover</p>
				</div>
				<div class="row col-6 text-center justify-content-center align-items-center pb-5">
					<img class="col-6 w-25 img-fluid" src="images/calendar.png">
					<p class="col-6 text-center fst-italic fs-3">Eliminate overbooking and streamline bookings</p>
				</div>
				<div class="row col-6 text-center justify-content-center align-items-center pb-5">
