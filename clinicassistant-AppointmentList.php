                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="mt-4 text-center p-3">
                            <a href="clinicassistant-CreateAppointment.php" class="btn btn-secondary">Create Appointment</a>
                        </div>
                        ...
                        <div class="justify-content-center d-flex mt-4 p-2">Result(s)</div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                    <td>John</td>
                                    <td>12-05-1996 09:35am</td>
                                    <td>
                                        <a href="clinicassistant-UpdateAppointment.php" class="btn btn-secondary">Update</a>
                                    </td>
                                    <td> 
                                        <a href="#" class="btn btn-secondary" onclick="alert('Appointment Deleted!')">Delete</a>
                                    </td>
                                    </tr>
                                    <tr>
                                    <td>Mary</td>
                                    <td>23-03-1992 02:35pm</td>
                                    <td>
                                        <a href="clinicassistant-UpdateAppointment.php" class="btn btn-secondary">Update</a>
                                    </td>
                                    <td> 
