...
<head>
    ...
    <title>Clinic Assistant Past Appointment</title>
</head>
        ...
        <div class="container-fluid">
            ...
            <div id="navbarCollapse" class="collapse navbar-collapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="clinicassistant-PastAppointment.php">Appointment History</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="w-100"></div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <td>Patient</td>
                                    <td> 
                                        <a href="clinicassistant-PastAppointmentDetail.php" class="btn btn-secondary">View Treatment Details</a>
                                    </td>
                                    </tr>
                                    <tr>
                                    <td>Mary</td>
